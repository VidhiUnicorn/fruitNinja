...
function preload(){
  ...
  fruitNoiseSound = loadSound("knifeSwoosh.mp3");
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    if(score % 10===0){
      monsterGroup.velocityX =  monsterGroup.velocityX  + 0.05;
    }
    // Increase score if sword touching fruit
    if(fruitGroup.isTouching(knife)){
      fruitGroup.destroyEach();
      score = score + 2;
      fruitNoiseSound.play();
      //goNoise.addSound(gameOverNoise);
    }
    else
    {
